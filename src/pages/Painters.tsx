      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          >
            ...
            <h1 className="text-4xl lg:text-5xl font-bold text-blue-950 mb-6 tracking-tight">
              參與畫家
            </h1>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {painters.map((painter, index) => (
            <motion.div
              ...
              className="bg-white rounded-3xl overflow-hidden shadow-sm border border-blue-50 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col"
            >
              <div className="aspect-[4/3] overflow-hidden relative group bg-stone-50/50 flex items-center justify-center p-8">
                <Link to={`/painter/${painter.id}`} className="relative block w-48 h-48 rounded-full overflow-hidden border-4 border-white shadow-md hover:shadow-xl transition-shadow duration-300">
                  <img 
              ...
              <div className="p-8 flex-1 flex flex-col">
                <h3 className="text-2xl font-bold text-blue-950 mb-4">{painter.name}</h3>
                <p className="text-blue-900/70 leading-relaxed flex-1">
                  {painter.shortBio}
                </p>
