...
export const painters: Painter[] = [
  {
    id: 'antonio',
    name: '蘇一仲',
    avatar: 'images/painters/painter-avatar-1.png',
    detailImage: 'images/painters/painter-1.png',
    shortBio: '自2013年起投入繪畫創作，雖非科班出身，卻以旺盛的熱情與敏銳的藝術直覺，迅速建立個人風格。蘇會長認為創作歷程如人生歷練，分為「茫然、偶然、豁然、果然」四階段，每幅畫作皆蘊含著情感與思想的交織。善於結合東方哲思與西方技法，透過色彩與光影描繪生活的體悟與心靈的風景。其繪畫啟蒙於青年時期，曾受教於旅日名師吳棟材，奠定了紮實基礎。',
    fullBio: '蘇一仲董事長，彰化鹿港人，現任和泰興業－大金空調會長，亦為台灣企業界的重量級人物。除事業卓然有成，更是一位深具人文涵養與藝術熱情的創作者。空閒時喜愛書法、繪畫、寫作、料理等藝文活動，著有《人生總有酸甜苦辣》、《魔術董事長：要最好，你非變不可》等書，展現其豐富多面的生命樣貌。',
    philosophy: '自2013年起投入繪畫創作，雖非科班出身，卻以旺盛的熱情與敏銳的藝術直覺，迅速建立個人風格。他認為創作歷程如人生歷練，分為「茫然、偶然、豁然、果然」四階段，每幅畫作皆蘊含著情感與思想的交織。他善於結合東方哲思與西方技法，透過色彩與光影描繪生活的體悟與心靈的風景。其繪畫啟蒙於青年時期，曾受教於旅日名師吳棟材，奠定了紮實基礎。',
    exhibitions: [
      '2016年 | 中正紀念堂《士林三賢》聯展（與王健、白省三）',
      '2019年 | 台北科技大學《意象·藝象》三人聯展（與卓秀冬、李昕）'
    ],
    charity: '蘇一仲董事長於2010-11年擔任國際扶輪3522地區總監，長年投身公益，關注偏鄉、教育、環保與弱勢議題。他深信藝術不僅能美化生活，更能傳遞關懷與力量。多次以畫作義賣支持扶輪社會服務計畫，身體力行地實踐「以愛傳愛、以藝行善」的理念。企業家的影響力，藝術家的熱忱，皆成為他持續為台灣社會注入溫暖與正能量的泉源。',
    education: [
      '國立政治大學 外交學系',
  ...
  },
  {
    id: 'willie',
    name: '白文亮',
    avatar: 'images/painters/painter-avatar-2.png',
    detailImage: 'images/painters/painter-2.png',
    shortBio: '自1995年起鑽研素描與水彩，啟蒙於李永裕老師門下，奠定深厚的寫實基礎。自2009年起專注油畫創作，師承洪堯順與陳佑朋老師，畫風日趨成熟，筆觸沈穩、色彩深厚，展現出細膩的觀察力與深刻的人文關懷。白董事長多年來持續創作並積極參與聯展，其風格融合東方精神與西方技法，寫實中蘊含詩意，細膩描繪自然、生活與人情萬象。',
    fullBio: '白文亮自1995年起鑽研素描與水彩，啟蒙於李永裕老師門下，奠定深厚的寫實基礎。自2009年起專注油畫創作，師承洪堯順與陳佑朋老師，畫風日趨成熟，筆觸沈穩、色彩深厚，展現出細膩的觀察力與深刻的人文關懷。多年來持續創作並積極參與聯展，其風格融合東方精神與西方技法，寫實中蘊含詩意，細膩描繪自然、生活與人情萬象。白文亮以理性的企業背景結合藝術的情感視野，於創作路上不輟耕耘，透過畫筆傳遞深邃的人文精神與東西方融合的藝術觀點。',
    philosophy: '1. 循環經濟・永續之美: 白老師巧妙結合環保理念，將廢棄人造鑽石顆粒灑落於未乾的油彩上，使其在畫布上綻放第二生命，彷彿永恆守護者，與畫作共存不朽。 2. 渾厚肌理・視覺張力:作品展現渾厚多層的肌理，立體感十足，勾勒出剛柔並濟的畫面張力，令人印象深刻。 3. 綠色情懷・療癒心靈:色彩以綠為主軸，呼應自然之美與林文昌教授的色彩療癒理念，傳遞生命力與內心的安定感。',
    exhibitions: [
      '2010 | 洪堯順師生聯展（台北縣蘆洲鄉）',
      '2017.02 | 海峽兩岸文藝界迎春畫展（台北市議會）',
      '2017.06 | 真理大學牛津學堂藝術中心 師生校友聯展',
      '2020.09 | 「藝猶未盡」聯展（蘆洲集賢分館藝文中心）'
    ],
    education: [
      '美國德州大學達拉斯校區（University of Texas at Dallas） 理學士',
      '美國達拉斯大學（University of Dallas） 企業管理碩士',
      '美國休倫大學（Huron International University） 企業管理博士（Ph.D., DBA）'
    ],
    experience: [
      '財團法人白永傳紀念教育基金會 董事長',
      '中國砂輪公司 副董事長',
      '台灣工商企業聯合會 常務理事 、台灣機械工業同業公會 顧問',
      '台北市政府 市政顧問、新北市政府 市政顧問',
      '中華民國全國工業總會 第11屆理事、新北市工業會榮譽理事長',
      '輔仁大學、國立台北商業技術學院 兼任講師',
      '龍華科技大學 兼任助理教授',
      '真理大學 兼任副教授'
    ],
    artworks: [
  ...
  },
  {
    id: 'cho',
    name: '卓秀冬',
    avatar: 'images/painters/painter-avatar-3.png',
    detailImage: 'images/painters/painter-3.png',
    shortBio: '技進於藝，藝進於道。\n卓秀冬女士創作深植人文哲思，陶藝承襲吳讓農與洪仲毅技法，強調高溫釉變之美；抽象畫風結合點線面與哲理情感；書法筆力雄厚、結構嚴謹，展現傳統精神與現代審美的融合。藝術評論者曾長生教授評其作品為：「人文哲思的新抽象表現」，點出其創作背後深邃的文化精神與思想厚度。',
    fullBio: '卓秀冬女士將豐富的情感融入創作，其藝術創作結合學術哲思與現代藝術語彙，風格涵蓋陶藝、抽象繪畫與書法，具深厚人文內涵與現代美感。她擅長捕捉光影與結構的變化，讓藝術作品充滿生命力與人文溫度。',
    philosophy: '技進於藝，藝進於道。創作深植人文哲思，陶藝承襲吳讓農與洪仲毅技法，強調高溫釉變之美；抽象畫風結合點線面與哲理情感；書法筆力雄厚、結構嚴謹，展現傳統精神與現代審美的融合。藝術評論者曾長生教授評其作品為：「人文哲思的新抽象表現」，點出其創作背後深邃的文化精神與思想厚度。',
    exhibitions: [
      '2022｜《浩瀚宇宙旋歌》入選奧地利維也納國際藝術網展售平台',
      '2022｜《Flowers—Brilliant》入選義大利國際藝術網展',
      '受邀參展 New York Contemporary Abstract Art 及歐美七國藝術聯盟聯展',
      '入選英國諾丁漢國際藝術網展，列名全球16位藝術家紀錄',
      '陶藝作品展於中山民眾館、台灣藝術教育館',
      '中華科技大學藝術中心舉辦個展',
      '2023｜參與中國美術協會義賣聯展',
      '2024｜入選大亞洲區藝術展（台中自然科學博物館）',
      '2024｜油畫《生命多美好》入選亞太國際藝術聯展（由國立東華大學承辦）'
    ],
    education: [
      '國立政治大學教育學博士，專攻教育哲學與藝術賞析',
      '美國柏克萊大學、史丹佛大學、密西根州立大學 藝術教育與美感研究',
      'GR美術館 藝術專題研究'
    ],
    experience: [
      '大學開設《台灣陶瓷藝術之美》課程講師',
  ...
  },
  {
    id: 'hsinlee',
    name: '李昕',
    avatar: 'images/painters/painter-avatar-4.png',
    detailImage: 'images/painters/painter-4.png',
    shortBio: '李昕女士的創作融合舞蹈記憶與潛意識情感，以女性生命經驗為底蘊，結合多媒材語彙，發展獨特視覺風格。文化評論者蔡詩萍曾評：「她的畫，不僅是舞蹈風格的，而根本是流動意識的奔騰。」早期畫風狂放誇張，關注兩性張力與情慾糾葛；近年走向隱喻內斂，探索靈與性的交織，並透過系列創作如《舞蹈練習室》，以重複與變奏表現自我蛻變與當代表現性。',
    fullBio: '李昕女士是一位跨界藝術家，其創作深深紮根於她豐富的生命歷程——從專業牙醫師到佛拉明哥舞者，再到視覺藝術家。她透過色彩與線條的交響，捕捉流動中的意識與情感，作品展現出極具張力的女性視角與生命能量。',
    philosophy: '李昕的創作融合舞蹈記憶與潛意識情感，以女性生命經驗為底蘊，發展獨特視覺風格。早期畫風狂放誇張，近年走向隱喻內斂，探索靈與性的交織，並透過系列如《舞蹈練習室》的重複與變奏，表現自我蛻變與當代表現性。正如蔡詩萍所評：「她的畫，根本是流動意識的奔騰。」其中《舞蹈練習室》系列更透過160張作品的重複中成就自我蛻變。',
    exhibitions: [
      '1996｜臺北文化中心巡迴個展《我看見我跳舞》、入選臺北市立美術館雙年展《權力與欲望》',
      '1998｜台南文化中心個展《閣樓女子》，作品《女牙醫師與男病人》入選《台灣當代女畫家年鑑》',
      '2013-2016｜瓷器聯展《玻陶之歌》、十女藝術家聯展《十全十美》',
      '2017｜威尼斯雙年展、日本福岡藝術博覽會，個展《海風的探索》《身體，時光之舞》',
      '2018-2019｜參展上海、紐約、香港、韓國、中正紀念堂等藝博與聯展',
      '2022｜個展《夏礿》、《網。魍》、《花。漾》於中正紀念堂展出',
      '2023｜圓山花博爭艷館個展《秋之翼》',
      '2024｜淡江文錙藝文中心創作展《她方 Herstory》、 Rachel Art Gallery個展',
      '2024｜《舞蹈練習室》系列個展於 Rachel Art Gallery'
    ],
    education: [
      '台北醫學大學 牙醫系畢業',
      '國立台北藝術大學 美術系碩士班就讀中',
  ...
  },
  {
    id: 'huang',
    name: '黃麗香',
    avatar: 'images/painters/painter-avatar-5.png',
    detailImage: 'images/painters/painter-5.png',
    shortBio: '長年以詩與畫抒發情感，將日常心境化作畫筆書寫的視覺日記。\n黃麗香女士於藝術大學研究所深造期間，體悟中西美學與戲劇色彩之融合，進而將戲劇的張力與節奏感融入畫作之中，使其作品如一場撫慰心靈的藝術演出。其創作風格獨具個人特色，筆觸中富含詩性與情感深度，展現生命與藝術交會的溫度。',
    fullBio: '黃麗香女士以自然為師，將大地的美好化為永恆的藝術印記。她熱愛大自然，長年透過詩與畫抒發情感，將日常心境化作畫筆書寫的視覺日記。身為企業家與藝術特使，她致力於推廣藝術文化，並將戲劇的張力與節奏感融入色調與構圖之中。',
    philosophy: '長年以詩與畫抒發情感，將日常心境化作畫筆書寫的視覺日記。於藝術大學研究所深造期間，體悟中西美學與戲劇色彩之融合，進而將戲劇的張力與節奏感融入畫作之中，使其作品如一場撫慰心靈的藝術演出。筆劃中富含詩性與情感深度，展現生命與藝術交會的溫度。',
    exhibitions: [
      '2024.02｜《茶道禪觀》台灣茶書畫藝術協會藝術名家邀請展',
      '2024.03｜《月花迎春風聯展》',
      '2024.08｜《第三屆兩岸學術層峰菁英交流展》',
      '2025.03｜《輸墨天下－藝游陽明大院名家邀請展》台北陽明大院',
      '2025.04｜《藝曼万千－台日名家交流展》日本大阪市立美術館',
      '2025.04｜日本NPO法人藝象萬千文化教育學院 嘉賞狀'
    ],
    education: [
      '國立藝術大學 戲劇研究所 碩士'
    ],
