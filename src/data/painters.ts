...
export const painters: Painter[] = [
  {
    ...
    experience: [
      '和泰興�      { id: 2, title: '靜謐森林', image: 'images/artworks/art-2.jpg', collected: true, description: '走進這片深邃的林間，仿佛能聽見微風拂過樹梢的沙沙聲。作品以層次豐富的綠色調，描繪了自然界最純粹的安穩感，傳達出一種遠離塵囂、與心靈對話的深刻意境，令人身心沉靜。' },
