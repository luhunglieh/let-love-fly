...
export const painters: Painter[] = [
  ...
  },
  {
    ...
    experience: [],
    artworks: [
      { id: 9, title: '花之讚歌', image: 'images/artworks/art-9.jpg', collected: false, description: '盛開的花朵展現出生命最燦爛的一面，色彩鮮明且充滿動感。作品強調生命的爆發力，傳遞出一種積極向上、擁抱美好的樂觀精神，讓觀者感受到大自然賦予的強大治癒力量樣貌。' },
